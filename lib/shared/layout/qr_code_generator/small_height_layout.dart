...
class SmallHeightLayout extends StatefulWidget {
  const SmallHeightLayout({super.key});

  @override
  State<SmallHeightLayout> createState() => _SmallHeightLayoutState();
}

class _SmallHeightLayoutState extends State<SmallHeightLayout> {
                        ...
                        Expanded(
                          child: Column(
                            ...
                            children: [
                              Padding(
                                padding:
                                const EdgeInsets.only(left: 100.0, right: 200.0),
                                child: Text(
                                  "QR-Code Generator",
                                  style: TextStyle(
                                      color: unitingWhite,
                              ...
                              Padding(
                                padding:
                                const EdgeInsets.only(left: 120.0, right: 200.0, bottom: 10.0),
                                child: Text(
                                  "qr_generator_title_text".tr(),
                                  style: TextStyle(
                                      color: unitingWhite, fontSize: 19.0),
